        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatNoPreferred = table.Column<string>(type: "TEXT", nullable: true),
                    CheckedIn = table.Column<bool>(type: "INTEGER", nullable: false),
                    CheckedInAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_FlightId_SeatNo",
                table: "Seats",
                columns: new[] { "FlightId", "SeatNo" },
                unique: true);
        }
